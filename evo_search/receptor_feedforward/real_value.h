...
double real_value(const vector<double> &geny)
{
    ...
    ht_1 = adaint(10.0, 5.0, geny);
    ht_2 = adaint(15.0, 5.0, geny);
    ht_3 = adaint(25.0, 5.0, geny);
    ...
    ht_1_a = adaint(25.0, 2.0, geny);
    ht_2_a = adaint(25.0, 5.0, geny);
    ht_3_a = adaint(25.0, 15.0, geny);
